...
def cleanup_old_reports(test_reports_dir: Path, keep_latest: int = 10):
    ...
    if deleted_count > 0:
        print(f"🧹 Cleaned up {deleted_count} old test report(s), keeping latest {keep_latest}")
...
def main():
    ...
    test_suites = [
        ...
        ("test_create_annotation_template.py::TestCreateAnnotationTemplateIntegration", "Create Templates", 2),
    ...
    print(f"💡 JUnit XML file can be used by CI/CD systems (GitHub Actions, Jenkins, etc.)")
